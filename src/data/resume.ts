...
export const experience: Experience[] = [
  {
    ...
    skills: ['Web Development', 'Full-stack Development', 'Interactive Applications', 'Team Collaboration', 'React.js', 'Node.js'],
    type: 'internship'
  }
];
...
export const achievements: Achievement[] = [
  {
    ...
    description: 'Comprehensive certification covering Python programming fundamentals, data structures, data analysis, and data science applications from National Programme on Technology Enhanced Learning',
    date: '2024',
  ...
  },
  {
    ...
    description: 'Led a team of 4 members in developing an AI-powered mental health support application with conversational interface and mood tracking capabilities',
  ...
  },
  {
    ...
    description: 'Developed assistive technology application for people with disabilities featuring voice commands, adaptive interfaces, and accessibility-first design',
  ...
  },
  {
    ...
    description: 'Built comprehensive e-commerce platform for traditional Tamil food products using modern full-stack technologies including React, Node.js, and MongoDB',
...
// Career objective
export const careerObjective = "Seeking opportunities to leverage my proficiency in Python and C programming, along with my full-stack development skills, to contribute to innovative software solutions and continue growing as a technology professional. Passionate about creating user-centric applications that solve real-world problems.";

// Resume summary
export const resumeSummary = {
  title: "Full Stack Developer & Computer Science Student",
  highlights: [
    "B.E Computer Science and Engineering student with 7.0 CGPA",
