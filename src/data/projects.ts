...
export const projects: Project[] = [
  {
    ...
    description:
      'A comprehensive mental health support application designed to provide users with accessible counseling and emotional support through an intelligent chatting interface.',
    ...
    category: 'ai',
    status: 'completed',
    images: ['/images/projects/chatbot1.png', '/images/projects/Chatbot.png'],
    highlights: [
  ...
  },
  {
    ...
    description:
      'An assistive technology application designed to help people with disabilities navigate daily tasks and access resources more easily through voice commands and adaptive interfaces.',
    ...
    category: 'ai',
    status: 'completed',
    liveUrl: 'https://disability-people.vercel.app/',
    githubUrl: 'https://github.com/Praneshkk25/disability_people.git',
    images: [
      '/images/projects/disability-assistant-1.png',
      '/images/projects/disability-assistant-2.png',
    ],
    highlights: [
  ...
  },
  {
    ...
    description:
      'A comprehensive e-commerce platform specializing in traditional Tamil food products, featuring modern web technologies and seamless user experience for online food ordering and delivery.',
    ...
    category: 'fullstack',
    status: 'completed',
    liveUrl: 'https://chrunchy.netlify.app/',
    githubUrl: ' https://github.com/praneshkk2505/Internship-Project.git',
    images: [
      '/images/projects/chrunchy-tamizhan-1.png',
      '/images/projects/chrunchy-tamizhan-2.png',
      '/images/projects/chrunchy-tamizhan-3.png',
    ],
    highlights: [
