...
export const personalInfo = {
  ...
  description: "Passionate developer with expertise in Python, C programming, and full-stack web development. NPTEL certified in Python for Data Science with hands-on experience in building innovative applications.",
  profileImage: "/images/projects/WhatsApp Image 2025-11-30 at 08.54.00_f6ac79c0.jpg",
  email: "pkpraneshkk@gmail.com",
  phone: "+91 9443525784",
  location: "171/228, Kadagam, Tiruchirapalli, Ariyamangalam(PO), Namakkal(DT), 637214",
  
  // Professional summary
  objective: "Seeking opportunities to leverage my proficiency in Python and C programming, along with my full-stack development skills, to contribute to innovative software solutions and continue growing as a technology professional.",
  ...
  education: {
    current: {
      institution: "SCMA COLLEGE OF TECHNOLOGY",
  ...
  experience: {
    internship: {
      ...
      skills: ["Web Development", "Full-stack Development", "Interactive Applications", "Team Collaboration"]
    }
  },
  ...
  skills: {
    programming: [
      ...
      { name: "C Programming", proficiency: 85, category: "Programming Languages" },
    ...
    development: [
      { name: "Full Stack Development", proficiency: 85, category: "Development" },
      { name: "Web Development", proficiency: 88, category: "Development" },
      { name: "App Development", proficiency: 80, category: "Development" },
      { name: "Frontend Development", proficiency: 85, category: "Development" },
  ...
  certifications: [
    {
      ...
      description: "Comprehensive certification covering Python programming fundamentals, data structures, data analysis, and data science applications"
    }
  ],
  ...
  featuredProjects: [
    {
      ...
      teamSize: 4,
      description: "Led development of a mental health support application with chat functionality"
    },
    {
      name: "DISABILITY PEOPLE ASSISTANT",
      role: "Team Lead", 
      duration: "APR 2022 - MAY 2022",
      description: "Developed assistive technology application for people with disabilities"
    },
    {
      name: "Chrunchy Tamizhan E-commerce App",
      role: "Developer",
      duration: "JUNE 2025 - SEP 2025",
      description: "Built comprehensive e-commerce application with modern web technologies"
    }
  ],
...
export const getSkillsByCategory = (category: string) => {
  const allSkills = [...skills.programming, ...skills.development, ...skills.tools];
